...
sudo sed -i.bak s/'  height: 28px'/'  height: 36px'/g /usr/share/themes/Tetra/gnome-shell/gnome-shell.css
sudo sed -i.bak s/'  height: 28px'/'  height: 36px'/g /usr/share/themes/Tetra-dark/gnome-shell/gnome-shell.css
sudo sed -i.bak s/'  height: 28px'/'  height: 36px'/g /usr/share/themes/Tetra-light/gnome-shell/gnome-shell.css
